...
const String apiURL = "https://529c6b509e354cd6b0de59810f35f66e.api.mockbin.io/";
const String locationURL = "https://6f26efd713044977b64b266fd59e26cb.api.mockbin.io/";
  ...
  beaconScanner.ranging(regions).listen((ScanResult? result) {
    if (result != null && result.beacons.isNotEmpty) {
      ...
      if (lastRequestTime == null || now.difference(lastRequestTime!).inMinutes >= 1) {
        ...
        makePostRequest(result.beacons.first.id.proximityUUID, apiURL);
      }
    } else {
...
Future<void> makePostRequest(String uuid, String postUrl) async {
...
handlePosition(Position? position) {
  if (position != null) {
    ...
    makePostRequest(pos, locationURL);
  }
}
